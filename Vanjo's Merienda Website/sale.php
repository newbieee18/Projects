...
<html lang="en">
  ...
  <title>Vanjo's Merienda Sale</title> 
...
<div class="row" style ="max-width: 100%;">
    <div class="col-3 menu">
       &emsp;<img src="burger/gif1.gif" style="width: 90%; height: 20%; border: 2px solid black;"><br><br>
      &emsp;<img src="pork/gif2.gif" style="width: 90%; height: 20%; border: 2px solid black;"><br><br>
      &emsp;<img src="beef/gif1.gif" style="width: 90%; height: 20%; border: 2px solid black;">
    </div>
<br><br><br>
  ...
  <?php
    ...
    $sql="select * from sale limit 0, 3";
    if($res = mysqli_query($conn, $sql)){
    if (mysqli_num_rows($res) > 0){
    ...
    <a href='buy.php?edit5=".$row['id']."' style='text-decoration: none;'><button type='button' class='btn-warning'>Buy</button>&nbsp;</a>
    <button type='submit' name='add5' class='btn-success'>Add to Cart</button></center><br>
    </div></form>";
  }
  }else{
  ...
  <?php
    ...
    $sql="select * from sale limit 3, 3";
    if($res = mysqli_query($conn, $sql)){
    if (mysqli_num_rows($res) > 0){
  ...
  <?php
    ...
    $sql="select * from sale limit 6, 3";
    if($res = mysqli_query($conn, $sql)){
    if (mysqli_num_rows($res) > 0){

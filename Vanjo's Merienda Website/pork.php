...
<div class="row" style ="max-width: 100%;">
    <div class="col-3 menu" data-aos="zoom-in-up">
      &emsp;<img src="pork/gif1.gif" style="width: 90%; border: 2px solid black;"><br><br>
      &emsp;<img src="pork/gif2.gif" style="width: 90%; height: 20%; border: 2px solid black;"><br><br>
      &emsp;<img src="pork/gif3.gif" style="width: 90%; height: 20%; border: 2px solid black;">
    </div>
<br><br><br>
  ...
  <?php
    ...
    $sql="select * from pork limit 0, 3";
    if($res = mysqli_query($conn, $sql)){
    if (mysqli_num_rows($res) > 0){
  ...
  <?php
    ...
    $sql="select * from pork limit 3, 3";
    if($res = mysqli_query($conn, $sql)){
    if (mysqli_num_rows($res) > 0){
  ...
  <?php
    ...
    $sql="select * from pork limit 6, 3";
    if($res = mysqli_query($conn, $sql)){
    if (mysqli_num_rows($res) > 0){
